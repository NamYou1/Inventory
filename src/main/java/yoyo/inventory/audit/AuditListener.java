package yoyo.inventory.audit;

import jakarta.persistence.*;
import org.springframework.security.core.Authentication;
import org.springframework.security.core.context.SecurityContextHolder;
import yoyo.inventory.config.SpringContextHolder;
import yoyo.inventory.entities.AuditLog;
import yoyo.inventory.repository.AuditLogRepository;
        ...
        try {
            ...
            while (current != null) {
                for (java.lang.reflect.Field field : current.getDeclaredFields()) {
                    ...
                    if (java.util.Collection.class.isAssignableFrom(field.getType()) || java.util.Map.class.isAssignableFrom(field.getType())) {
                        continue;
                    }
